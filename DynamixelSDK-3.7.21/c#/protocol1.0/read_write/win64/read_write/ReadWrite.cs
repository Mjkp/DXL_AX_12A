...
namespace read_write
{
  class ReadWrite
  {
    ...
    public const int DXL_MAXIMUM_POSITION_VALUE      = 1000;                // and this value (note that the Dynamixel would not move when the position value is out of movable range. Check e-manual about the range of the Dynamixel you use.)
